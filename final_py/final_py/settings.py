"""
Django settings for final_py project.
...
SECRET_KEY = 'django-insecure-t&ldx4vb&+v%xdedj687h)fd*eod1f+$1k4jhrp=uvh!w)4s8('
...
WSGI_APPLICATION = 'final_py.wsgi.application'
